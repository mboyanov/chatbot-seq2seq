...
class Seq2SeqModel(object):
  ...
  def __init__(self,
    ...
    for i in range(MAX_OUTPUT_SIZE + 1):
    ...
    if forward_only:
      ...
      self.loss = tf.nn.seq2seq.sequence_loss(self.outputs[:-1], targets, self.target_weights[:-1], target_vocab_size)
    else:
  ...
  def step(self, session, encoder_inputs, decoder_inputs, target_weights, forward_only):
    ...
    encoder_size, decoder_size = (MAX_INPUT_SIZE, MAX_OUTPUT_SIZE)
